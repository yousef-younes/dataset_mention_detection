'''
This module was used to generate results in table 2. It can be run as it is.
In train function, line 103 specify which portion of the section to feed into the model.
In test function, line 60 should match line 518 in the train function.
Then the main method will invoke both the train and test methods and save the results in the associated files. Finally,
the combine_results function is invoked to compute the final measures. Tensorboard_folder save data to be visualized by tensorboard.
'''
...
from transformers import RobertaTokenizer,RobertaForSequenceClassification,BertTokenizer,BertForSequenceClassification,AdamW, get_linear_schedule_with_warmup
...
def train(output_dir, seed, writer):
    ...
    model = RobertaForSequenceClassification.from_pretrained("roberta-base", num_labels=2, output_attentions=False,
                                                             output_hidden_states=False)
...
if __name__ == '__main__':
    ...
    exp_path = "Bert/exp_"
    tensor_path = 'save_Bert/exp_'
    main()
    out_file = "Bert/all_bert_results.txt"
    exp_folder = "./Bert/exp"
