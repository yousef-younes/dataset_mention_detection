...
f = open("bert_bfl_content_results.txt", "w")
...
for i in range(len(seeds)):
    ...
    f.write('EXP {0} \n'.format(i))
    file_path= './Bert_content_bfl/bert_'+str(seeds[i])+'/result' 
...
for i in range(5):
    ...
    file_path= './Bert_content_bfl/bert_'+str(seeds[i])+'/result_'+str(i)+'.txt'
