...
line 535: Here is the name of the model used in the experiment.
line 97-98: the appropriate tokenizer should be activated and the other should be commented out.
lines 191-192: the appropriate model should be activated and the other should be commented out. 
lines 378-379: also load the appropriate model
lines 384-385: load the appropriate tokenizer
line 393-394: comment and uncomment the appropriate line
lines 397-398: comment and uncomment the appropriate line
'''
...
def train(output_dir,seed):
    ...
    for epoch_i in range(0, epochs):
        ...
        for step, batch in enumerate(trainDataLoader):
            ...
            #
            # As we unpack the batch and move to gpu
